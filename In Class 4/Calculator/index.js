/**
 * Created by deven on 9/16/2017.
 */
/* Controller handles calculations and binding
 */

var calculator = angular.module('calculator', ['ngRoute', 'ngSanitize']);



calculator.controller('Ctrl', ['$scope', '$location', '$timeout', '$http', '$window', function($scope, $location, $timeout, $http, $window) {
